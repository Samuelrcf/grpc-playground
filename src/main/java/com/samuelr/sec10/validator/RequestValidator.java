package com.samuelr.sec10.validator;

import java.util.Optional;

import com.samuelr.models.sec10.ErrorMessage;
import com.samuelr.models.sec10.ValidationCode;
...
public class RequestValidator {
	...
	public static Optional<StatusRuntimeException> validateAccount(int accountNumber){
		...
		var metadata = toMetadata(ValidationCode.NOT_FOUND);
		return Optional.of(Status.NOT_FOUND.asRuntimeException(metadata));
	}
