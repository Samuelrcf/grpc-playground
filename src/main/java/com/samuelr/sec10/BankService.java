...
import com.samuelr.models.sec10.AccountBalance;
import com.samuelr.models.sec10.BalanceCheckRequest;
import com.samuelr.models.sec10.BankServiceGrpc.BankServiceImplBase;
import com.samuelr.models.sec10.Money;
import com.samuelr.models.sec10.WithdrawRequest;
import com.samuelr.sec10.repository.AccountRepository;
import com.samuelr.sec10.validator.RequestValidator;
...
public class BankService extends BankServiceImplBase {
	...
	public void getAccountBalance(BalanceCheckRequest request, StreamObserver<AccountBalance> responseObserver) {
		Optional<StatusRuntimeException> status = RequestValidator.validateAccount(request.getAccountNumber());
		if(status.isEmpty()) {
	...
	public void withdraw(WithdrawRequest request, StreamObserver<Money> responseObserver) {
		Optional<StatusRuntimeException> status = 
