...
public final class GuessNumberGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.samuelr.models.sec08.GuessRequest,
      com.samuelr.models.sec08.GuessResponse> getMakeGuessMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MakeGuess",
      requestType = com.samuelr.models.sec08.GuessRequest.class,
      responseType = com.samuelr.models.sec08.GuessResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.samuelr.models.sec08.GuessRequest,
      com.samuelr.models.sec08.GuessResponse> getMakeGuessMethod() {
    io.grpc.MethodDescriptor<com.samuelr.models.sec08.GuessRequest, com.samuelr.models.sec08.GuessResponse> getMakeGuessMethod;
      ...
      synchronized (GuessNumberGrpc.class) {
        if ((getMakeGuessMethod = GuessNumberGrpc.getMakeGuessMethod) == null) {
          GuessNumberGrpc.getMakeGuessMethod = getMakeGuessMethod =
              io.grpc.MethodDescriptor.<com.samuelr.models.sec08.GuessRequest, com.samuelr.models.sec08.GuessResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MakeGuess"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.samuelr.models.sec08.GuessRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.samuelr.models.sec08.GuessResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.samuelr.models.sec08.GuessRequest> makeGuess(
        io.grpc.stub.StreamObserver<com.samuelr.models.sec08.GuessResponse> responseObserver) {
  ...
  public static final class GuessNumberStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.samuelr.models.sec08.GuessRequest> makeGuess(
        io.grpc.stub.StreamObserver<com.samuelr.models.sec08.GuessResponse> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.samuelr.models.sec08.GuessRequest,
              com.samuelr.models.sec08.GuessResponse>(
  ...
  private static abstract class GuessNumberBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.samuelr.models.sec08.Game.getDescriptor();
    }
