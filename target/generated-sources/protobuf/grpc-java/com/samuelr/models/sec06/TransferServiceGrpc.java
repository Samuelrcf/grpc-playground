...
public final class TransferServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "sec06.TransferService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.samuelr.models.sec06.TransferRequest,
      com.samuelr.models.sec06.TransferResponse> getTransferMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Transfer",
      requestType = com.samuelr.models.sec06.TransferRequest.class,
      responseType = com.samuelr.models.sec06.TransferResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.samuelr.models.sec06.TransferRequest,
      com.samuelr.models.sec06.TransferResponse> getTransferMethod() {
    io.grpc.MethodDescriptor<com.samuelr.models.sec06.TransferRequest, com.samuelr.models.sec06.TransferResponse> getTransferMethod;
      ...
      synchronized (TransferServiceGrpc.class) {
        if ((getTransferMethod = TransferServiceGrpc.getTransferMethod) == null) {
          TransferServiceGrpc.getTransferMethod = getTransferMethod =
              io.grpc.MethodDescriptor.<com.samuelr.models.sec06.TransferRequest, com.samuelr.models.sec06.TransferResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Transfer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.samuelr.models.sec06.TransferRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.samuelr.models.sec06.TransferResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.samuelr.models.sec06.TransferRequest> transfer(
        io.grpc.stub.StreamObserver<com.samuelr.models.sec06.TransferResponse> responseObserver) {
  ...
  public static final class TransferServiceStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.samuelr.models.sec06.TransferRequest> transfer(
        io.grpc.stub.StreamObserver<com.samuelr.models.sec06.TransferResponse> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.samuelr.models.sec06.TransferRequest,
              com.samuelr.models.sec06.TransferResponse>(
