...
@javax.annotation.Generated(
    ...
    comments = "Source: sec09/input-validation.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class BankServiceGrpc {

  private BankServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "sec09.BankService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.samuelr.models.sec09.BalanceCheckRequest,
      com.samuelr.models.sec09.AccountBalance> getGetAccountBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAccountBalance",
      requestType = com.samuelr.models.sec09.BalanceCheckRequest.class,
      responseType = com.samuelr.models.sec09.AccountBalance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.samuelr.models.sec09.BalanceCheckRequest,
      com.samuelr.models.sec09.AccountBalance> getGetAccountBalanceMethod() {
    io.grpc.MethodDescriptor<com.samuelr.models.sec09.BalanceCheckRequest, com.samuelr.models.sec09.AccountBalance> getGetAccountBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetAccountBalanceMethod = BankServiceGrpc.getGetAccountBalanceMethod) == null) {
          BankServiceGrpc.getGetAccountBalanceMethod = getGetAccountBalanceMethod =
              io.grpc.MethodDescriptor.<com.samuelr.models.sec09.BalanceCheckRequest, com.samuelr.models.sec09.AccountBalance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAccountBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.samuelr.models.sec09.BalanceCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.samuelr.models.sec09.AccountBalance.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.samuelr.models.sec09.WithdrawRequest,
      com.samuelr.models.sec09.Money> getWithdrawMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Withdraw",
      requestType = com.samuelr.models.sec09.WithdrawRequest.class,
      responseType = com.samuelr.models.sec09.Money.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.samuelr.models.sec09.WithdrawRequest,
      com.samuelr.models.sec09.Money> getWithdrawMethod() {
    io.grpc.MethodDescriptor<com.samuelr.models.sec09.WithdrawRequest, com.samuelr.models.sec09.Money> getWithdrawMethod;
    if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
          BankServiceGrpc.getWithdrawMethod = getWithdrawMethod =
              io.grpc.MethodDescriptor.<com.samuelr.models.sec09.WithdrawRequest, com.samuelr.models.sec09.Money>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Withdraw"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.samuelr.models.sec09.WithdrawRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.samuelr.models.sec09.Money.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getAccountBalance(com.samuelr.models.sec09.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.samuelr.models.sec09.AccountBalance> responseObserver) {
     ...
     * </pre>
     */
    default void withdraw(com.samuelr.models.sec09.WithdrawRequest request,
        io.grpc.stub.StreamObserver<com.samuelr.models.sec09.Money> responseObserver) {
  ...
  public static final class BankServiceStub
     ...
     * </pre>
     */
    public void getAccountBalance(com.samuelr.models.sec09.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.samuelr.models.sec09.AccountBalance> responseObserver) {
     ...
     * </pre>
     */
    public void withdraw(com.samuelr.models.sec09.WithdrawRequest request,
        io.grpc.stub.StreamObserver<com.samuelr.models.sec09.Money> responseObserver) {
  ...
  public static final class BankServiceBlockingStub
     ...
     * </pre>
     */
    public com.samuelr.models.sec09.AccountBalance getAccountBalance(com.samuelr.models.sec09.BalanceCheckRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.samuelr.models.sec09.Money> withdraw(
        com.samuelr.models.sec09.WithdrawRequest request) {
  ...
  public static final class BankServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.samuelr.models.sec09.AccountBalance> getAccountBalance(
        com.samuelr.models.sec09.BalanceCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ACCOUNT_BALANCE:
          serviceImpl.getAccountBalance((com.samuelr.models.sec09.BalanceCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.samuelr.models.sec09.AccountBalance>) responseObserver);
          break;
        case METHODID_WITHDRAW:
          serviceImpl.withdraw((com.samuelr.models.sec09.WithdrawRequest) request,
              (io.grpc.stub.StreamObserver<com.samuelr.models.sec09.Money>) responseObserver);
          break;
        default:
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              com.samuelr.models.sec09.AccountBalance>(
                service, METHODID_GET_ACCOUNT_BALANCE)))
        .addMethod(
          getWithdrawMethod(),
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              com.samuelr.models.sec09.WithdrawRequest,
              com.samuelr.models.sec09.Money>(
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.samuelr.models.sec09.InputValidation.getDescriptor();
    }
